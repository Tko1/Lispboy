(ns lispboy.opcodes
  (:require [clojure.data.json :as json]
            ...
            [lispboy.util :as util]))

;; That's right,  I'm getting the actual data from online ..
;; (def raw-opcode-data
;;   (json/read-json  (slurp "https://gbdev.github.io/gb-opcodes/Opcodes.json")))
  ...
  {:unprefixed
   {0xA7
    ...
    {:mnemonic "JR",
     ...
     :cycles [12 8],
     :operands
     [{:name "C", :immediate true} {:name "r8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xA6
    {:mnemonic "AND",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "10H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x13
    {:mnemonic "INC",
    ...
    {:mnemonic "JR",
     ...
     :cycles [12 8],
     :operands
     [{:name "NC", :immediate true} {:name "r8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x93
    {:mnemonic "SUB",
    ...
    {:mnemonic "ADD",
     ...
     :cycles [8],
     :operands
     [{:name "A", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "Z", :N "0", :H "H", :C "C"}},
    0x27
    {:mnemonic "DAA",
    ...
    {:mnemonic "OR",
     :bytes 2,
     :cycles [8],
     :operands [{:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "Z", :N "0", :H "0", :C "0"}},
    0x4B
    {:mnemonic "LD",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "00H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x94
    {:mnemonic "SUB",
    ...
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "B", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x76
    {:mnemonic "HALT",
    ...
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "D", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x26
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "H", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x69
    {:mnemonic "LD",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "38H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xBD
    {:mnemonic "CP",
    ...
    {:mnemonic "LD",
     ...
     :cycles [12],
     :operands
     [{:name "HL", :immediate false} {:name "d8", :bytes 1, :immediate true}],
     :immediate false,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x4C
    {:mnemonic "LD",
    ...
    {:mnemonic "LD",
     ...
     :cycles [12],
     :operands
     [{:name "DE", :immediate true} {:name "d16", :bytes 2, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x4E
    {:mnemonic "LD",
    ...
    {:mnemonic "JR",
     ...
     :cycles [12 8],
     :operands
     [{:name "NZ", :immediate true} {:name "r8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x1D
    {:mnemonic "DEC",
    ...
    {:mnemonic "LD",
     ...
     :cycles [12],
     :operands
     [{:name "SP", :immediate true} {:name "d16", :bytes 2, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x5B
    {:mnemonic "LD",
    ...
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "E", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x61
    {:mnemonic "LD",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "18H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xAF
    {:mnemonic "XOR",
    ...
    {:mnemonic "ADD",
     ...
     :cycles [16],
     :operands
     [{:name "SP", :immediate true} {:name "r8", :bytes 1, :immediate true}],
     :immediate true,
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "28H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x3B
    {:mnemonic "DEC",
    ...
    {:mnemonic "JR",
     :bytes 2,
     :cycles [12],
     :operands [{:name "r8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xA4
    {:mnemonic "AND",
    ...
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "C", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x59
    {:mnemonic "LD",
    ...
    {:mnemonic "LD",
     ...
     [{:name "HL", :immediate true}
      {:name "SP", :increment true, :immediate true}],
     :immediate true,
     :flags {:Z "0", :N "0", :H "H", :C "C"}},
    0xFB
    {:mnemonic "EI",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "30H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x96
    {:mnemonic "SUB",
    ...
    {:mnemonic "LD",
     ...
     :cycles [12],
     :operands
     [{:name "BC", :immediate true} {:name "d16", :bytes 2, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xE5
    {:mnemonic "PUSH",
    ...
    {:mnemonic "LD",
     ...
     :cycles [12],
     :operands
     [{:name "HL", :immediate true} {:name "d16", :bytes 2, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x0C
    {:mnemonic "INC",
    ...
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "08H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xD0
    {:mnemonic "RET",
    ...
    {:mnemonic "LD",
     ...
     :cycles [8],
     :operands
     [{:name "L", :immediate true} {:name "d8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0xE7
    {:mnemonic "RST",
     :bytes 1,
     :cycles [16],
     :operands [{:name "20H", :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x68
    {:mnemonic "LD",
    ...
    {:mnemonic "JR",
     ...
     :cycles [12 8],
     :operands
     [{:name "Z", :immediate true} {:name "r8", :bytes 1, :immediate true}],
     :immediate true,
     :flags {:Z "-", :N "-", :H "-", :C "-"}},
    0x32
    {:mnemonic "LD",
